...
function Sidebar({ userInfo, subdata }){
    ...
    const isWatchLaterPage = location.pathname === '/feed/playlist/list=WL';
    const isLikedVideosPage = location.pathname === '/feed/playlist/list=LL';
                                ...
                                <div className="link home">
                                    {isWatchLaterPage ? (
                                        <button name="list" value="WL">
                                            <NavLink to='/feed/playlist/list=WL'>
                                                <svg height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm2.97 14.95L10 13.87V7h2v5.76l4.03 2.49-1.06 1.7z"></path></svg>
                                ...
                                <div className="link home">
                                    {isLikedVideosPage ? (
                                        <button name="list" value="LL">
                                            <NavLink to='/feed/playlist/list=LL'>
                                                <svg height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="M3,11h3v10H3V11z M18.77,11h-4.23l1.52-4.94C16.38,5.03,15.54,4,14.38,4c-0.58,0-1.14,0.24-1.52,0.65L7,11v10h10.43 c1.06,0,1.98-0.67,2.19-1.61l1.34-6C21.23,12.15,20.18,11,18.77,11z"></path></svg>
                                                    ...
                                                    <button>
                                                        <NavLink to={`/@${sub.slug}`}>
                                                            <div className="linkimmg" style={{minWidth: '24px', width: '24px', height: '24px', borderRadius: '50%', overflow: 'hidden', marginRight: '20px'}}>
                                                                <img alt="s" src={sub.image ? sub.image : thumbnail} width="100%" height="100%" />
                                                            </div>
                                                            <span>{sub.name}</span>
                                                        </NavLink>
                                                    </button>
