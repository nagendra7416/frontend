                ...
                <div className="items">
                    <div className="box home">
                        { isHomePage ? (
                            ...
                            <NavLink to='/'>
                                <div className="link">
                                <svg height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="m12 4.44 7 6.09V20h-4v-6H9v6H5v-9.47l7-6.09m0-1.32-8 6.96V21h6v-6h4v6h6V10.08l-8-6.96z"></path></svg>
                                    <label>Home</label>
                                </div>
                            </NavLink>
                        )}
                    ...
                    <div className="box subscriptions">
                        { isSubscriptionsPage ? (
                            ...
                            <NavLink to='/feed/subscriptions'>
                                <div className="link">
                                    <svg height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="M10 18v-6l5 3-5 3zm7-15H7v1h10V3zm3 3H4v1h16V6zm2 3H2v12h20V9zM3 10h18v10H3V10z"></path></svg>
                                    <label>Subscriptions</label>
                                </div>
                            </NavLink>
                        )}
                    ...
                    <div className="box library">
                        { isLibraryPage ? (
                            ...
                            <NavLink to='/feed/library'>
                                <div className="link">
                                    <svg height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="m11 7 6 3.5-6 3.5V7zm7 13H4V6H3v15h15v-1zm3-2H6V3h15v15zM7 17h13V4H7v13z"></path></svg>
                                    <label>Library</label>
                                </div>
                            </NavLink>
                        )}
