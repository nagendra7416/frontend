                                        ...
                                        {userInfo ? (
                                            <>
                                                {userInfo.channelimage ? (
                                                    <NavLink to={`/c/@${userInfo.channelslug}`}>
                                                        <button>
